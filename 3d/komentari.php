<?php
    ...
    $rezultat = $veza->prepare("SELECT tekst,autor,vrijeme FROM komentar WHERE novost=? order by vrijeme desc");
	...
	$rezultat->execute();
	 ...
	 foreach ($rezultat->fetchAll() as $komentar) {
		 print $komentar['tekst']." , ".$komentar['autor']." , ".$komentar['vrijeme']."<br>";
	 }
